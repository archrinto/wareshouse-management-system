<div>
    <div class="mb-6">
        <div class="mb-3 flex items-center gap-4">
            ...
            <h3 class="text-2xl font-semibold">{{ __('Add Dispatching') }}</h3>
        </div>
    </div>
        ...
        <div class="bg-white rounded-md shadow col-span-2">
            <form wire:submit.prevent="submit">
                    ...
                    <div>
                        <div class="mb-3">
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                <x-select-search
                                    :data="$shipperOptions"
                                    wire:model.defer="shipperId"
                                    placeholder="-- {{ __('Select Shipper') }} --"
                                />
                            </div>
                            @error('shipperId')
                ...
                <div class="bg-gray-50 px-4 py-4 mt-4 flex justify-between border-t rounded-b-md">
                    ...
                    <button type="submit" class="inline-flex items-center gap-3 justify-center rounded-md border border-transparent bg-slate-900 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">

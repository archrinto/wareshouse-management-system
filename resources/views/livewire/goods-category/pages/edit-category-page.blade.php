<div>
    <div class="mb-6">
        <div class="mb-3 flex items-center gap-4">
            ...
            <h3 class="text-2xl font-semibold">{{ __('Edit Goods Category') }}</h3>
        </div>
    </div>
            ...
            <form wire:submit.prevent="submit" method="POST">
                <div class="shadow sm:overflow-hidden sm:rounded-md">
                    ...
                    <div class="bg-gray-50 px-4 py-4 flex justify-between sm:px-6 border-t">
                        <button type="submit" class="inline-flex justify-center rounded-md bg-white py-2 px-4 text-sm font-medium border border-gray-300 shadow-sm hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                            {{ __('Cancel') }}
                        </button>

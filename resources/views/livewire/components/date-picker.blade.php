    ...
    <div class="container mx-auto">
        <div class="mb-5 w-64">
            <div class="relative">
                ...
                <div class="bg-white mt-12 rounded-md shadow p-4 absolute top-0 left-0" style="width: 17rem" x-show.transition="showDatepicker" @click.away="showDatepicker = false">

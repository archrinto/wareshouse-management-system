<div class="w-64 min-h-screen bg-slate-800" >
    ...
    <div class="p-3 text-slate-300">
        <a
            href="/"
            class="{{(request()->is('dashboard') || request()->is('/')) ? ' bg-slate-900 text-white ' : '' }} flex items-center gap-3 p-3 rounded-md mb-1 hover:bg-slate-900"
        >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        >
            ...
            <span>{{ __('Stock Opname') }}</span>
        </a>
        @endcan
        @can('user.view')
        <a href="/users" class="{{(request()->is('users*')) ? ' bg-slate-900 text-white ' : '' }} flex items-center gap-3 p-3 rounded-md mb-2 hover:bg-slate-900">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        @endcan
        @role('Super Admin')
        <a href="/roles" class="{{(request()->is('roles*')) ? ' bg-slate-900 text-white ' : '' }} flex items-center gap-3 p-3 rounded-md mb-2 hover:bg-slate-900">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        >
            ...
            <span>{{ __('Transaction Category') }}</span>
        </a>
        @endcan
    </div>
</div>

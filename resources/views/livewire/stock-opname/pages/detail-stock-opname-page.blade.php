                ...
                <div class="mb-8">
                    <dl>
                        ...
                        <div class="mb-4 grid grid-cols-3 gap-4">
                            ...
                            <dd class="text-gray-900 col-span-2 mt-0">
                                {{ __($transaction->category->operation) ?? 'n/a' }}
                            </dd>
                        </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-4 gap-4">
                        @foreach($transaction->items as $item)
                            <div class="col-span-2 text-gray-900">{{ $item->goods->codeName ?? 'n/a' }}</div>
                            <div class="text-gray-900">{{ number_format($item->quantity) }}</div>
                            <div class="text-gray-900">{{ $item->goods->unit->symbol ?? 'n/a' }}</div>
                        @endforeach
                    </div>
                </div>
